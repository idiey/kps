 ...
 * @see app/Http/Controllers/Kps/PenerokaController.php:59
 ...
 * @see app/Http/Controllers/Kps/PenerokaController.php:71
 * @route '/kps/sites/{site}/peneroka'
 */
 ...
 * @see app/Http/Controllers/Kps/PenerokaController.php:82
 ...
 * @see app/Http/Controllers/Kps/PenerokaController.php:99
 ...
 * @see app/Http/Controllers/Kps/PenerokaController.php:114
 * @route '/kps/sites/{site}/peneroka/{peneroka}'
 */
...
const PenerokaController = { index, create, store, edit, update, destroy }

export default PenerokaController