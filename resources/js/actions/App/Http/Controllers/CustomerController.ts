 ...
 * @see app/Http/Controllers/CustomerController.php:94
 ...
 * @see app/Http/Controllers/CustomerController.php:130
 * @route '/customers/search/autocomplete'
 */
...
search.definition = {
    methods: ["get","head"],
    url: '/customers/search/autocomplete',
} satisfies RouteDefinition<["get","head"]>
...
const CustomerController = { index, create, store, show, edit, update, destroy, search }
