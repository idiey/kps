...
/**
* @see \App\Http\Controllers\Admin\SettingsController::initializeDefaults
 * @see app/Http/Controllers/Admin/SettingsController.php:86
 * @route '/admin/settings/initialize'
 */
export const initializeDefaults = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: initializeDefaults.url(options),
    method: 'post',
})

initializeDefaults.definition = {
    methods: ["post"],
 ...
 * @route '/admin/settings/initialize'
 */
initializeDefaults.url = (options?: RouteQueryOptions) => {
    return initializeDefaults.definition.url + queryParams(options)
}
 ...
 * @route '/admin/settings/initialize'
 */
initializeDefaults.post = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: initializeDefaults.url(options),
    method: 'post',
})
 ...
 * @route '/admin/settings/initialize'
 */
    const initializeDefaultsForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: initializeDefaults.url(options),
        method: 'post',
    })
 ...
 * @route '/admin/settings/initialize'
 */
        initializeDefaultsForm.post = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: initializeDefaults.url(options),
            method: 'post',
        })
    
    initializeDefaults.form = initializeDefaultsForm
const SettingsController = { index, store, update, destroy, initializeDefaults }
