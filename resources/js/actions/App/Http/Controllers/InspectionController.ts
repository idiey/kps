...
/**
* @see \App\Http\Controllers\InspectionController::approveWithConditions
 * @see app/Http/Controllers/InspectionController.php:163
 * @route '/inspections/{inspection}/approve-with-conditions'
 */
export const approveWithConditions = (args: { inspection: number | { id: number } } | [inspection: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: approveWithConditions.url(args, options),
    method: 'post',
})

approveWithConditions.definition = {
    methods: ["post"],
 ...
 * @route '/inspections/{inspection}/approve-with-conditions'
 */
approveWithConditions.url = (args: { inspection: number | { id: number } } | [inspection: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { inspection: args }
    }
    ...
    return approveWithConditions.definition.url
            .replace('{inspection}', parsedArgs.inspection.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
 ...
 * @route '/inspections/{inspection}/approve-with-conditions'
 */
approveWithConditions.post = (args: { inspection: number | { id: number } } | [inspection: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: approveWithConditions.url(args, options),
    method: 'post',
})
 ...
 * @route '/inspections/{inspection}/approve-with-conditions'
 */
    const approveWithConditionsForm = (args: { inspection: number | { id: number } } | [inspection: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: approveWithConditions.url(args, options),
        method: 'post',
    })
 ...
 * @route '/inspections/{inspection}/approve-with-conditions'
 */
        approveWithConditionsForm.post = (args: { inspection: number | { id: number } } | [inspection: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: approveWithConditions.url(args, options),
            method: 'post',
        })
    
    approveWithConditions.form = approveWithConditionsForm
/**
...
const InspectionController = { create, store, index, show, edit, update, destroy, approve, approveWithConditions, reject }
