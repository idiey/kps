...
const variantClasses = computed(() => {
    const baseClasses =
        'flex w-full gap-3 rounded-lg border p-4 shadow-lg transition-all';
...
<template>
    ...
    >
        ...
        <button
            type="button"
            @click="emit('close')"
            class="shrink-0 rounded-md p-1 transition-colors hover:bg-black/10 focus:ring-2 focus:ring-offset-2 focus:outline-none dark:hover:bg-white/10"
