...
const form = useForm({
    ...
    expected_completion_date: formatDateForInput(
        props.job.expected_completion_date,
    ),
...
const submitForm = () => {
    form.put(update.url(props.job.id), {
        onSuccess: () => {
            success(
                'Job Updated',
                'Workshop job has been updated successfully.',
            );
        },
        onError: () => {
            error(
                'Update Failed',
                'Failed to update job. Please check the form for errors.',
            );
        },
    });
};
                    ...
                    <CardContent class="space-y-6">
                        ...
                        <div class="flex justify-end gap-2">
                            <Button
                                ...
                                as-child
                            >
                                <Link :href="show.url(job.id)"> Cancel </Link>
                            </Button>
