...
const form = useForm({
    company_id: props.workshop.company_id?.toString() || 'none',
    name: props.workshop.name,
    code: props.workshop.code,
    address: props.workshop.address || '',
    phone: props.workshop.phone || '',
    email: props.workshop.email || '',
    is_active: props.workshop.is_active,
});
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Edit Workshop', href: `/admin/workshops/${props.workshop.id}/edit` },
];
</script>
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="text-2xl font-bold tracking-tight">Edit Workshop</h2>
                <p class="text-muted-foreground">{{ workshop.name }}</p>
            </div>
        </div>
