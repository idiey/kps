...
import { index, update } from '@/routes/admin/workflows';
...
const form = useForm({
    ...
    is_default: !!props.workflow.is_default,
});

const submit = () => {
    form.put(update.url(props.workflow.id));
};
</script>
        ...
        <div class="flex h-full flex-1 flex-col gap-4 p-4">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Update the basic details for the workflow.
                    </CardDescription>
                </CardHeader>
                <CardContent>
