            ...
            >
                ...
                >
                    ...
                    <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                        Manage your workshop efficiently and effectively.
                    </p>
                ...
                >
                    <img
                        src="/images/logo.png"
                        alt="Workshop System Logo"
                        class="w-full max-w-none h-24 object-contain translate-y-0 opacity-100 transition-all duration-750 starting:translate-y-6 starting:opacity-0"
                    />
                    <svg
