...
<template>
    <AuthLayout
        ...
        :description="t('auth.reset.description', 'Please enter your new password below')"
    >
        <Head :title="t('auth.reset.head', 'Reset password')" />
        ...
        >
            <div class="grid gap-6">
                ...
                >
                    ...
                    {{ t('auth.reset.action', 'Reset password') }}
                </Button>
            </div>
        </Form>
    </AuthLayout>
