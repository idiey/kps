...
<template>
    <Head :title="t('kps.sites.create', 'Create Site')" />

    <KpsShellLayout>
        <div class="space-y-6 max-w-3xl">
            <div>
                <h1 class="text-2xl font-semibold">{{ t('kps.sites.create', 'Create Site') }}</h1>
                <p class="text-muted-foreground">{{ t('kps.sites.create_desc', 'Add a new KPS site.') }}</p>
            </div>
            ...
            <form class="space-y-4" @submit.prevent="submit">
                ...
                <div class="flex gap-2">
                    <Button type="submit" :disabled="form.processing">{{ t('common.create', 'Create') }}</Button>
