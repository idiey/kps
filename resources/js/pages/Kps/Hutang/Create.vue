...
<template>
    <Head :title="t('kps.hutang.create', 'Create Hutang')" />
            ...
            <section class="flex flex-col gap-5 2xl:flex-row 2xl:items-end 2xl:justify-between">
                <div class="max-w-3xl">
                    ...
                    <h1 class="mt-3 text-4xl font-black tracking-[-0.04em] text-[#1b1b1b] md:text-5xl" style="font-family: Manrope, Inter, sans-serif;">
                        {{ t('kps.hutang.add', 'Add hutang') }}
                    </h1>
                    <p class="mt-4 max-w-2xl text-base leading-7 text-[#65534d] md:text-lg">
                        Create a new debt record for {{ site.name }} and assign its recovery priority.
                    </p>
                </div>
            ...
            <div class="grid gap-6 lg:grid-cols-[1.4fr,0.9fr]">
                <Card class="rounded-[34px] border-[#efdcd5] bg-white/92 shadow-[0_18px_50px_rgba(157,80,53,0.08)]">
                    <CardHeader class="border-b border-[#f0dfd8] pb-6">
                        ...
                        <p class="text-sm text-[#7f675f]">Enter the core recovery data. Priority controls the waterfall order.</p>
                    </CardHeader>

                    <CardContent class="pt-6">
                        <form class="space-y-5" @submit.prevent="submit">
                            <div class="grid gap-2">
                                <Label class="text-sm font-semibold text-[#2a2422]">Peneroka</Label>
                                <Select v-model="form.peneroka_id">
                                    <SelectTrigger class="rounded-2xl border-[#e6d1c7] bg-[#fffaf8] px-4 py-3">
                                ...
                                <InputError :message="form.errors.peneroka_id" />
                            </div>
                            ...
                            <div class="flex flex-wrap gap-3 pt-2">
                                ...
                                >
                                    {{ t('kps.hutang.create', 'Create Hutang') }}
                                </Button>
                ...
                <Card class="rounded-[34px] border-[#efdcd5] bg-white/88 shadow-[0_18px_50px_rgba(157,80,53,0.08)]">
                    <CardHeader class="border-b border-[#f0dfd8] pb-6">
                        <CardTitle class="text-xl font-black text-[#1b1b1b]" style="font-family: Manrope, Inter, sans-serif;">Recovery notes</CardTitle>
                    </CardHeader>
                    <CardContent class="space-y-4 pt-6">
                        ...
                        <div class="space-y-3 text-sm text-[#65534d]">
                            <p>Lower priority values are recovered first in the allocation waterfall.</p>
                            <p>Keep descriptions specific so reports and statements stay understandable later.</p>
                        </div>
                    </CardContent>
                </Card>
            </div>
