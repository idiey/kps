...
const { globalFilter, sorting, extraFilters, setFilter, goToPage } = useServerTable(
    `/kps/sites/${props.site.id}/allocations`,
    props.filters,
);
                ...
                <div class="flex flex-col gap-4 border-b border-[#f0dfd8] px-7 py-6">
                    <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                        ...
                        <div class="flex flex-wrap items-end gap-3">
                            ...
                            <Button variant="outline" class="rounded-full border-[#e2c9c0]" @click="applyMonthFilter">Apply</Button>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-3 lg:flex-row">
                        ...
                        >
                            ...
                            <option value="unallocated_amount">Unallocated</option>
                        </select>
                        <select
                ...
                <div class="overflow-x-auto px-2 py-3">
                    ...
                    >
                        <template #month-cell="{ row }">
                            <span class="font-semibold text-[#1b1b1b]">{{ formatDate(row.original.month) }}</span>
                        </template>
