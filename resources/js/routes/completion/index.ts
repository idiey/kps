 ...
 */
    ...
    sign.form = signForm
/**
* @see \App\Http\Controllers\RepairCompletionController::submit
 * @see app/Http/Controllers/RepairCompletionController.php:147
 * @route '/completion/{report}/submit'
 */
export const submit = (args: { report: number | { id: number } } | [report: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
 ...
 * @route '/completion/{report}/submit'
 */
submit.url = (args: { report: number | { id: number } } | [report: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { report: args }
    }
 ...
 * @route '/completion/{report}/submit'
 */
submit.post = (args: { report: number | { id: number } } | [report: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: submit.url(args, options),
    method: 'post',
})
 ...
 * @route '/completion/{report}/submit'
 */
    const submitForm = (args: { report: number | { id: number } } | [report: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/completion/{report}/submit'
 */
        submitForm.post = (args: { report: number | { id: number } } | [report: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: submit.url(args, options),
            method: 'post',
        })
...
addPart: Object.assign(addPart, addPart),
removePart: Object.assign(removePart, removePart),
}
