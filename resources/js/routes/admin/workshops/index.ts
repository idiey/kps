...
/**
* @see \App\Http\Controllers\Admin\WorkshopAnalyticsController::analytics
 * @see app/Http/Controllers/Admin/WorkshopAnalyticsController.php:23
 * @route '/admin/workshops/{workshop}/analytics'
 */
export const analytics = (args: { workshop: string | { id: string } } | [workshop: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
 ...
 * @route '/admin/workshops/{workshop}/analytics'
 */
analytics.url = (args: { workshop: string | { id: string } } | [workshop: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { workshop: args }
    }
 ...
 * @route '/admin/workshops/{workshop}/analytics'
 */
analytics.get = (args: { workshop: string | { id: string } } | [workshop: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: analytics.url(args, options),
    method: 'get',
})
/**
 ...
 * @route '/admin/workshops/{workshop}/analytics'
 */
analytics.head = (args: { workshop: string | { id: string } } | [workshop: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: analytics.url(args, options),
    method: 'head',
})
 ...
 * @route '/admin/workshops/{workshop}/analytics'
 */
    const analyticsForm = (args: { workshop: string | { id: string } } | [workshop: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
 ...
 * @route '/admin/workshops/{workshop}/analytics'
 */
        analyticsForm.get = (args: { workshop: string | { id: string } } | [workshop: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: analytics.url(args, options),
            method: 'get',
        })
            /**
 ...
 * @route '/admin/workshops/{workshop}/analytics'
 */
        analyticsForm.head = (args: { workshop: string | { id: string } } | [workshop: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
